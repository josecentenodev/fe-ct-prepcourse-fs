...
function agregarStringInvertida() {
  ...
  String.prototype.reverse = function () {
    ...
    const fromStringToArray = this.split("");
    for (var i = 0; i < fromStringToArray.length; i++) {
      arrayFromString.unshift(fromStringToArray[i]);
    }
    fromArrayToString = arrayFromString.join("");
